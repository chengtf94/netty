...
import io.netty.example.chengtf.study.heima.chat.client.message.LoginRequestMessage;
...
/**
 * 协议编解码器：必须和 LengthFieldBasedFrameDecoder 一起使用，确保接到的 ByteBuf 消息是完整的
 *
 * @author: chengtf
 * @date: 2024/6/17
 */
...
public class MessageCodecSharable extends MessageToMessageCodec<ByteBuf, Message> {
    ...
    public void encode(ChannelHandlerContext ctx, Message msg, List<Object> outList) throws Exception {
        ...
        // 1字节的版本,
        out.writeByte(1);
        // 1字节的序列化方式：0为JDK序列化方式，1为JSON序列化方式
